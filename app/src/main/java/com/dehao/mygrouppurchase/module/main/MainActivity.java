...
import com.dehao.mygrouppurchase.base.BaseActivity;
import com.dehao.mygrouppurchase.data.repository.VideoRepo;
...
public class MainActivity extends BaseActivity {
    ...
    FloatingActionButton mFabToolbarFab;

    private static final String QUIT_TOAST = "连按两次退出应用";
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        showSelectedTab();
        changeNavigation();//点击选择切换Fragment
    }
    ...
    private final void changeNavigation() {
        mRdgToolbar.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
